...
export function Table ( props ) {
    ...
    return (
        <div>
            ...
            <div className="row justify-content-center"><h3>Aggregated Dividends {props.data.year}</h3></div>
            {generate_table( aggregated_data_keys, aggregated_data )}

            <br></br> <br></br>

            <div className="row justify-content-center"><h3>Full List of Dividends {props.data.year}</h3></div>
